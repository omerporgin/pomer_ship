<!-- Modal -->
<div class="modal fade" id="add-location" tabindex="-1" aria-labelledby="add-location-label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="add-location-button" data-url="{{ route('api_add_location') }}">
